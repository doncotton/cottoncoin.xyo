# cottoncoin.xyo [![Github Actions][gha-badge]][gha] [![Hardhat][hardhat-badge]][hardhat] [![License: MIT][license-badge]][license]

[gha]: https://github.com/doncotton/cottoncoin.xyo/actions
[gha-badge]: https://github.com/doncotton/cottoncoin.xyo/actions/workflows/ci.yml/badge.svg
...
This project includes a `.devcontainer/devcontainer.json` configuration. Open it in any Dev Container-compatible
environment (VS Code, Ona/Gitpod Flex, GitHub Codespaces) and run `bun install` to get started.

To view the coverage report generated by `bun run coverage`, open `coverage/index.html` in a browser or use the
